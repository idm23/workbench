...
Create Date: 2026-08-17 13:32:28.500848
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("resume_token", sa.String(length=200), nullable=True),
    ...
    with op.batch_alter_table("projects", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("agent_backend", sa.String(length=50), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("projects", schema=None) as batch_op:
        batch_op.drop_column("agent_backend")
